...
public class GUI extends JFrame {
	...
	private ArrayList<RowOfWifiPoints> filteringList = new ArrayList<RowOfWifiPoints>();
	...
	private ArrayList<RowOfWifiPoints> mergedList;
	private ArrayList<RowOfWifiPoints> filteredList;
	...
	private void createEvents()
	{
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(csvFolder.fileChooser.showOpenDialog(mntmOpenFolder) == JFileChooser.APPROVE_OPTION) 
				{
					...
					if(temp.isDirectory())
					{
						...
						try {
							mergedList = ReaderWriter.notSortedFileToArrayListOfTenMostPowerfulWifiPoints(listOfFiles);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
						...
						try {
							mergedList = ReaderWriter.notSortedFileToArrayList(csvFolderAbsPath);
		...
		mntmOpenMergedCsv.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(csvFolder.fileChooser.showOpenDialog(mntmOpenFolder) == JFileChooser.APPROVE_OPTION) 
				{
					csvFolderAbsPath = csvFolder.fileChooser.getSelectedFile().getAbsolutePath();
					try {
						mergedList = ReaderWriter.readerFromMergedCSVtoList(csvFolderAbsPath);
					} catch (Exception e1) {
						e1.printStackTrace();
					}
		...
		btnCreateMergedCsv.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					try {
						filteredList = Filters.filtercsvFileByGPS(mergedList,txtLon.getText(),
								txtLat.getText(), txtLon2.getText(), txtLat2.getText()); // 32.16821204 34.80379573 32.16777491 34.80285957
					} catch (Exception e1) {
						e1.printStackTrace();
					}
				}
				...
				{
					try {
						filteredList = Filters.filteringByTime(mergedList, txtStartTimeExtra.getText(), txtEndTimeExtra.getText());
				...
				{
					try {
						filteredList = Filters.filteringByTime(mergedList, txtStartTime.getText(), txtEndTime.getText());
					} catch (Exception e1) {
						e1.printStackTrace();
					}
				}
				...
				{
					try {
						filteredList = Filters.filteringByTime(mergedList, txtStartTimeExtra3.getText(), txtEndTimeExtra3.getText());
						filteredList = Filters.filteringByCoordinates(filteredList, txtLatExtra3.getText(), txtLonExtra3.getText());
						filteredList = Filters.filteringByID(filteredList, txtIDExtra3.getText());
					} catch (Exception e1) {
						e1.printStackTrace();
					}
				}
				else if(chckbxGPS.isSelected() && chckbxID.isSelected())
				{
					try {
						...
						filteredList = Filters.filteringByID(filteredList, txtIDExtra.getText());
					} catch (Exception e1) {
						e1.printStackTrace();
					}
				}
				...
				{
					try {
						ArrayList<RowOfWifiPoints> temp = Filters.filteringByID(mergedList, txtIDExtra2.getText());
						filteredList = Filters.filteringByTime(temp, txtStartTimeExtra2.getText(), txtEndTimeExtra2.getText());
				...
				{
					try {
						filteredList = Filters.filteringByID(mergedList, txtID.getText());
					} catch (Exception e1) {
						e1.printStackTrace();
					}
				}
				...
				{
					try {
						ReaderWriter.WriterToCsv(filteredList, saveFile.fileChooser.getSelectedFile().getAbsolutePath());
					} catch (Exception e1) {
						e1.printStackTrace();
					}
				}
